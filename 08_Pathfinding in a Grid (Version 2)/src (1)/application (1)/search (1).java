...
public class search {
	...
	public void uniform() {
		...
		while (found == false) {
			...
			if(Grid.grid[r][c].getType() == -3) {
				...
				visited.add(Grid.grid[r][c]);
				list.clear();
				System.out.println(r + "," + c + "    " + Grid.grid[r][c].getG());
				found = false;
			}
		}
	}
	...
	public void greedy() {
		...
		while (found == false) {
			...
			exploreNeighbors(r, c, numOfHops);
			for (int i = 1; i < list.size(); i++) {
				if (list.get(i).getH() > list.get(i - 1).getH()) {
					r = list.get(i - 1).getR();
					c = list.get(i - 1).getC();
				} else {
					r = list.get(i).getR();
			...
			if(Grid.grid[r][c].getType() == -3) {
				...
				visited.add(Grid.grid[r][c]);
				list.clear();
				System.out.println(r + "," + c + "    " + Grid.grid[r][c].getH());
				found = false;
			}
		}
	}
	...
	public void aStar() {
		...
		while (found == false) {
			...
			if(Grid.grid[r][c].getType() == -3) {
				...
				visited.add(Grid.grid[r][c]);
				list.clear();
				System.out.println(r + "," + c + "    " + Grid.grid[r][c].getF());
				found = false;
			}
		}
	}
