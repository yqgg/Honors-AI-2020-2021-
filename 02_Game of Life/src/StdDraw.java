 ...
 *  drawing嚙踐𨪚ethods that draw geometric shapes and methods that
 ...
 *  You save your image to a file using the <em>File 嚙踝蕭嚙� Save</em> menu option.
 ...
 *  call a drawing
 *  method嚙踐𤩅uch as {@code point()} or {@code line()}嚙踐𠗊he
 ...
 *       the canvas is permitted嚙踐𧗾owever, only the part of the object that
...
private static JMenuBar createMenuBar() {
    ...
    ***************************************************************************/
     ...
     * (<em>x</em><sub>1</sub>, <em>y</em><sub>1</sub>), ...,
     * (<em>x</em><sub><em>n</em>嚙踝蕭1</sub>, <em>y</em><sub><em>n</em>嚙踝蕭1</sub>).
     *
